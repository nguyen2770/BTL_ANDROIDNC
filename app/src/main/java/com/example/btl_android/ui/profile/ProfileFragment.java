package com.example.btl_android.ui.profile;
...
public class ProfileFragment extends Fragment {
    ...
    private TextView tvUserName, tvEmailProfile, tvFullName, tvPhoneNumber, tvAdress, tvPoints;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        userViewModel.getUserLiveData().observe(getViewLifecycleOwner(), user -> {
            if (user != null) {
                ...
                tvPoints.setText(user.getPoints() + " Điểm Green");
            }
        });
